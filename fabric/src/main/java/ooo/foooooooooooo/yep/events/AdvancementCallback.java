package ooo.foooooooooooo.yep.events;
...
public interface AdvancementCallback {
  Event<AdvancementCallback> EVENT = EventFactory.createArrayBacked(AdvancementCallback.class, (listeners) -> (player, advancement) -> {
